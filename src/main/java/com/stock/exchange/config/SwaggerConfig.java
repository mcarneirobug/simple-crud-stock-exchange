...
public class SwaggerConfig {
    ...
    private static final String BASE_PACKAGE = "com.stock.exchange.modules.operation.controller";
    private static final String API_TITLE = "Stock Exchange API";
    private static final String API_DESCRIPTION = "REST API for stock exchange management";
